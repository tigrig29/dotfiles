...
return {
	keys = {
		...
		{ key = "-", mods = "CTRL|LEADER", action = act.SplitVertical({ domain = "CurrentPaneDomain" }) },
		{ key = "|", mods = "SHIFT|CTRL|LEADER", action = act.SplitHorizontal({ domain = "CurrentPaneDomain" }) },
		...
		{ key = "M", mods = "SHIFT|LEADER", action = act.Hide },
		{ key = "N", mods = "SHIFT|LEADER", action = act.SpawnWindow },
		{ key = "P", mods = "SHIFT|LEADER", action = act.ActivateCommandPalette },
		{ key = "R", mods = "SHIFT|LEADER", action = act.ReloadConfiguration },
		{ key = "T", mods = "SHIFT|LEADER", action = act.SpawnTab("CurrentPaneDomain") },
		{
			key = "U",
			mods = "CTRL",
		...
		{ key = "t", mods = "LEADER", action = act.ActivatePaneDirection("Right") },
		{ key = "T", mods = "LEADER", action = act.AdjustPaneSize({ "Right", 1 }) },
		{ key = "s", mods = "LEADER", action = act.ActivatePaneDirection("Up") },
		{ key = "S", mods = "LEADER", action = act.AdjustPaneSize({ "Up", 1 }) },
		{ key = "k", mods = "LEADER", action = act.ActivatePaneDirection("Down") },
		{ key = "K", mods = "LEADER", action = act.AdjustPaneSize({ "Down", 1 }) },
	},
